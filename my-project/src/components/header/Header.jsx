...
const Header = () => {
  ...
  return (
    <div className="Container w-full">
      ...
      <div className="rounded-lg bg-no-repeat bg-cover bg-fixed group px-4" style={{ backgroundImage: `url(${Background})` }}>
        ...
        <div className="flex flex-col items-center pb-10 invisible lg:visible">
          ...
          <img className='group-hover:scale-110 group-hover:-translate-y-4 duration-500 w-14 h-14 -mt-2 -mr-12' src={HandIcon} alt="Talk"/>
        </div>
